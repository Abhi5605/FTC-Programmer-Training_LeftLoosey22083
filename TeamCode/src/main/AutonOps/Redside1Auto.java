...
@Autonomous(name = "Redside1Auto?", group = "Autonomous")

public class Redside1Auto extends LinearOpMode {

    private static final Logger log = LoggerFactory.getLogger(Redside1Auto.class);
