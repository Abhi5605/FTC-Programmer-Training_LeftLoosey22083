    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Path1 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(88.172, 8.862),
                                    new Pose(90.166, 63.582),
                                    new Pose(128.492, 62.252)
                            )
                    )
            ...
            Path2 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(128.492, 62.252), new Pose(82.191, 69.785))
                    )
                    .setConstantHeadingInterpolation(Math.toRadians(0))
                    .build();
            ...
            Path3 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(82.191, 69.785),
                                    new Pose(86.400, 36.775),
                                    new Pose(122.511, 35.225)
                            )
                    )
                    .setConstantHeadingInterpolation(Math.toRadians(0))
                    .build();
            ...
            Path4 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(122.511, 35.225),
                                    new Pose(91.274, 19.274),
                                    new Pose(86.843, 17.723)
                            )
                    )
                    .setConstantHeadingInterpolation(Math.toRadians(0))
                    .build();
            ...
            Path5 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(86.843, 17.723),
                                    new Pose(108.775, 10.855),
                                    new Pose(134.695, 11.077)
                            )
                    )
                    .setConstantHeadingInterpolation(Math.toRadians(0))
                    .build();
            ...
            Path6 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(134.695, 11.077), new Pose(94.818, 11.298))
                    )
                    .setConstantHeadingInterpolation(Math.toRadians(0))
                    .build();
        }
